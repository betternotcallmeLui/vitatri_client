        ...
        <header className={`landingHeader ${scrolled ? 'scrolled' : ''}`}>
            <div className="landingHeaderContainer">
                <div className="landingHeader_links">
                    ...
                    <Link className={`landingHeader_link ${scrolled ? 'scrolled' : ''}`} to="/">Software para pacientes</Link>
                ...
                <div className="landingHeader_buttons">
                    <Link className={`landingHeader_buttonLogin ${scrolled ? 'scrolled' : ''}`} to="/signup">Crear Cuenta</Link>
